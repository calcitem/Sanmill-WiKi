...
Otherwise, if you're a member of the Sanmill team, follow this guide.
...
Make sure you follow the [Prerequisites, How To Contribute (calcitem/Sanmill)](https://github.com/Calcitem/Sanmill/wiki/How-to-Contribute#prerequisites) guide.
...
- Email address: use your Calcitem email address
- Comment: `Key for signing commits for Calcitem`
...
uid                 [ultimate] Joao Moreno (Key for signing commits for Calcitem) <joao.moreno@Calcitem.com>
