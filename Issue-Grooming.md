Our GitHub community is one of the biggest reasons of our success. Every single day, you create some issues with inspiring ideas for new functionality, you tell us what works as expected and what doesn't, and you tell us how to improve what's already there. We appreciate every single issue you create. Thank you!
...
2. Has the community at large expressed interest in this functionality? I.e. has it gathered more than 2 up-votes or more than 2 comments?
...
In summary, a feature needs to pass one of 1-3 and 4. Otherwise, we'll close it as `out of scope`.
